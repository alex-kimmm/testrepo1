<div ng-app="typicms" ng-cloak ng-controller="ListController">
    ...
    <h1>
        <span>@{{ models.length }} @choice('sizes::global.sizes', 2)</span>
    </h1>
    ...
    <div class="table-responsive">
        ...
        <table st-persist="sizesTable" st-table="displayedModels" st-safe-src="models" st-order st-filter class="table table-condensed table-main">
            <thead>
                <tr>
                    <th class="delete"></th>
                    <th class="edit"></th>
