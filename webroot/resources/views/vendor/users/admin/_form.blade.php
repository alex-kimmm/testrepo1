...
<div class="row">
    <div class="col-sm-12">
        {!! BootForm::select(trans('validation.attributes.title'), 'usertitle_id', TypiCMS\Modules\Usertitles\Models\Usertitle::all()->pluck('title', 'id')->all(), null, array('class' => 'form-control')) !!}
    </div>
</div>
