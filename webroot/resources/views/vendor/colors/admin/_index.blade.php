<div ng-app="typicms" ng-cloak ng-controller="ListController">
    ...
    <h1>
        <span>@{{ models.length }} @choice('colors::global.colors', 2)</span>
    </h1>
    ...
    <div class="table-responsive">
        ...
        <table st-persist="colorsTable" st-table="displayedModels" st-safe-src="models" st-order st-filter class="table table-condensed table-main">
            <thead>
                <tr>
                    <th class="delete"></th>
                    <th class="edit"></th>
                    ...
                    <th st-sort="color_code" class="color_code st-sort">Color code</th>
                </tr>
                <tr>
                    <td colspan="4"></td>
                    <td>
