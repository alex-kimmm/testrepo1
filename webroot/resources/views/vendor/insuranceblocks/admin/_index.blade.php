<div ng-app="typicms" ng-cloak ng-controller="ListController">
    ...
    <h1>
        <span>@{{ models.length }} @choice('insuranceblocks::global.insuranceblocks', 2)</span>
    </h1>
    ...
    <div class="table-responsive">
        ...
        <table st-persist="insuranceblocksTable" st-table="displayedModels" st-safe-src="models" st-order st-filter class="table table-condensed table-main">
            <thead>
                <tr>
                    <th class="delete"></th>
                    <th class="edit"></th>
                    ...
                    <th st-sort="menu_title" class="title st-sort">Menu Title</th>
                    <th st-sort="in_menu" class="title st-sort">Is In Menu?</th>
                </tr>
                <tr>
                    <td colspan="4"></td>
                    <td>
