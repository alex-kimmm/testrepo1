<div ng-app="typicms" ng-cloak ng-controller="ListController">
    ...
    <h1>
        <span>@{{ models.length }} @choice('insurancelandings::global.insurancelandings', 2)</span>
    </h1>
    ...
    <div class="table-responsive">
        ...
        <table st-persist="insurancelandingsTable" st-table="displayedModels" st-safe-src="models" st-order st-filter class="table table-condensed table-main">
            <thead>
                <tr>
                    <th class="delete"></th>
                    <th class="edit"></th>
