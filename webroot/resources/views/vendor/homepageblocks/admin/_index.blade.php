<div ng-app="typicms" ng-cloak ng-controller="ListController">
    ...
    <h1>
        <span>@{{ models.length }} @choice('homepageblocks::global.homepageblocks', 2)</span>
    </h1>
    ...
    <div class="table-responsive">
        ...
        <table st-persist="homepageblocksTable" st-table="displayedModels" st-safe-src="models" st-order st-filter class="table table-condensed table-main">
            <thead>
                <tr>
                    <th class="delete"></th>
                    <th class="edit"></th>
                    ...
                    <th st-sort="subtitle" class="subtitle st-sort">Subtitle</th>
                    <th st-sort="benefits_url" class="benefits_url st-sort">Benefits URL</th>
            ...
            <tbody>
                <tr ng-repeat="model in displayedModels">
                    ...
                    <td><a href="@{{ model.benefits_url }}" target="_blank">@{{ model.benefits_url }}</a></td>
