                        ...
                        <div class="edit-detail-section-info">
                            ...
                            <form id="my_details_form" role="form" action="/profile/my-details" method="post">
                                ...
                                <div class="form-group">
                                    <input type="password" class="form-control placeholder-fix-edge" name="old_password" placeholder="Old password"/>
                                </div>

                                <div class="form-group">
                                    <input type="password" class="form-control placeholder-fix-edge" name="password" placeholder="Password"/>
                                </div>

                                <div class="form-group">
                                    <input type="password" class="form-control placeholder-fix-edge" name="password_confirmation" placeholder="Password confirmation"/>
                                </div>
                                @endif
