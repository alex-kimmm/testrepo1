					      		...
					      		<h4 class="panel-title">
					        		<a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
					        			<div class="total-to-pay">
								        	<span class="checkout-title">total to pay now</span>
								        	<span class="price">&pound; {{ $totalPrice }}</span>
							        	</div>
					        		</a>
					      		</h4>
					    	</div>
						    <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
						      	<div class="panel-bod total">
						      	    ...
						      	    <div class="row pay-detail">
                                        ...
                                        <span class="price">&pound; {{$vat}}</span>
                                    </div>
                                    @endif
                                    @if($ipt > 0)
                                    <div class="row pay-detail">
                                        <span class="title">IPT</span>
                                        <span class="price">&pound; {{$ipt}}</span>
                                    </div>
                                    @endif
						      	    @if($is_recurring)
						      	    <br>
								    <div class="row pay-detail">
										<span class="title">And then monthly</span>
