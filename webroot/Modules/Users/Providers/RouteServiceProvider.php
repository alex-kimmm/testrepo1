        ...
        $router->group(['namespace' => $this->namespace], function (Router $router) {
            ...
            $router->group(['prefix' => 'auth', 'middleware' => 'web'], function (Router $router) {
                ...
                $router->get(
                    ...
                    ['as' => 'resendconfirmationemail', 'uses' => 'RegistrationController@getResendConfirmationEmail']
                );
                $router->post('resendconfirmationemail', 'RegistrationController@postResendConfirmationEmail');
