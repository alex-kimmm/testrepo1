...
class PublicController extends BasePublicController
{
    ...
    protected $request;
    public function __construct(PageInterface $page, QuoteInterface $quoteInterface, Request $request)
    {
    ...
    public function uri($page = null)
    {
        ...
        return response()->view($templateDir.$template, compact('children', 'page', 'quote'));
    }
