...
use TypiCMS\Modules\Insurancepages\Repositories\InsurancepageInterface as Repository;
...
class ApiController extends BaseApiController
{
     ...
     * @return \Illuminate\Http\JsonResponse
     */
    public function destroy(Insurancepage $insurancepage)
    {
        $deleted = $this->repository->delete($insurancepage);
