...
use TypiCMS\Modules\Headerblocks\Repositories\HeaderblockInterface as Repository;
...
class ApiController extends BaseApiController {
     ...
     * @return \Illuminate\Http\JsonResponse
     */
    public function destroy(Headerblock $headerblock) {
        $deleted = $this->repository->delete($headerblock);
