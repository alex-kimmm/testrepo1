...
use TypiCMS\Modules\Slideshowitems\Repositories\SlideshowitemInterface as Repository;
...
class ApiController extends BaseApiController
{
     ...
     * @return \Illuminate\Http\JsonResponse
     */
    public function destroy(Slideshowitem $slideshowitem)
    {
        $deleted = $this->repository->delete($slideshowitem);
