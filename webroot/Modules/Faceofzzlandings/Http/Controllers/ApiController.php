...
use TypiCMS\Modules\Faceofzzlandings\Repositories\FaceofzzlandingInterface as Repository;
...
class ApiController extends BaseApiController
{
     ...
     * @return \Illuminate\Http\JsonResponse
     */
    public function destroy(Faceofzzlanding $faceofzzlanding)
    {
        $deleted = $this->repository->delete($faceofzzlanding);
